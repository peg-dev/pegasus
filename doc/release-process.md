...
* Update translations see [translation_process.md](https://github.com/pegasus/pegasus/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Pegasus for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit pegasus=v${VERSION} ../pegasus/contrib/gitian-descriptors/gitian-win.yml
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import pegasus/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
- Detached signatures will then be committed to the [pegasus-detached-sigs](https://github.com/pegasus/pegasus-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the pegasuscoin.online server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/pegasus/pegasus/releases/new) with a link to the archived release notes.
