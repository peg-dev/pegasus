...
====================================
This guide will show you how to build pegasusd (headless client) for OSX.
...
4.  (Optional) You can also install pegasusd to your path:
...
It's now available at `./pegasusd`, provided that you are still in the `src`
directory. We have to first create the RPC configuration file, though.

Run `./pegasusd` to get the filename where it should be put, or just try these
commands:

    echo -e "rpcuser=pegasusrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Pegasus/pegasus.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Pegasus/pegasus.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/Pegasus/debug.log

Other commands:
-------

    ./pegasusd -daemon # to start the pegasus daemon.
    ./pegasus-cli --help  # for a list of command-line options.
    ./pegasus-cli help    # When the daemon is running, to get a list of RPC commands
