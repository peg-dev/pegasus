...
This mechanism has been integrated into Bitcore-Node-Pegasus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pegasus/insight-api-pegasus#web-socket-api](https://github.com/pegasus/insight-api-pegasus#web-socket-api)
* API: [https://github.com/pegasus/insight-api-pegasus#swifttx-transactions](https://github.com/pegasus/insight-api-pegasus#swifttx-transactions)
...
By default, the Pegasus daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pegasus daemon:
