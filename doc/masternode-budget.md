...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PEG, _12_ times over the course of a year totaling _24000_ PEG.
...
When block `1000000` is reached you'll receive a payment for `1200` PEG.
