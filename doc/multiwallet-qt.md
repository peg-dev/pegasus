...
In order to support loading of multiple wallets in pegasus-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pegasus.cpp.
...
Changes to pegasus.cpp
----------------------
pegasus.cpp is the entry point into pegasus-qt, and as such, will require some minor modifications to provide hooks for
