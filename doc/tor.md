...
HiddenServicePort 989 127.0.0.1:5115
...
your pegasusd's P2P listen port (5115 by default).
```
-externalip=X   You can tell pegasus about its publicly reachable address using
                this option, and this can be a .onion address. Given the above
                configuration, you can find your onion address in
                /var/lib/tor/pegasus-service/hostname. Onion addresses are given
...
and open port 5115 on your firewall (or use -upnp).
