...
RESOURCES += src/qt/pegasus.qrc src/qt/pegasus_locale.qrc

TRANSLATIONS += src/qt/locale/pegasus_bg.ts \
                src/qt/locale/pegasus_de.ts \
                src/qt/locale/pegasus_en.ts \
                src/qt/locale/pegasus_es.ts \
                src/qt/locale/pegasus_fi.ts \
                src/qt/locale/pegasus_fr.ts \
                src/qt/locale/pegasus_it.ts \
                src/qt/locale/pegasus_ja.ts \
                src/qt/locale/pegasus_pl.ts \
                src/qt/locale/pegasus_pt.ts \
                src/qt/locale/pegasus_ru.ts \
                src/qt/locale/pegasus_sk.ts \
                src/qt/locale/pegasus_sv.ts \
                src/qt/locale/pegasus_vi.ts \
                src/qt/locale/pegasus_zh_CN.ts \
                src/qt/locale/pegasus_zh_TW.ts
