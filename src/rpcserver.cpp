...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Pegasus server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pegasus features */
        {"pegasus", "masternode", &masternode, true, true, false},
        {"pegasus", "listmasternodes", &listmasternodes, true, true, false},
        {"pegasus", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pegasus", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pegasus", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pegasus", "masternodedebug", &masternodedebug, true, true, false},
        {"pegasus", "startmasternode", &startmasternode, true, true, false},
        {"pegasus", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pegasus", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pegasus", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pegasus", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pegasus", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pegasus", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pegasus", "mnbudget", &mnbudget, true, true, false},
        {"pegasus", "preparebudget", &preparebudget, true, true, false},
        {"pegasus", "submitbudget", &submitbudget, true, true, false},
        {"pegasus", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pegasus", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pegasus", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pegasus", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pegasus", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pegasus", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pegasus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pegasus", "checkbudgets", &checkbudgets, true, true, false},
        {"pegasus", "mnsync", &mnsync, true, true, false},
        {"pegasus", "spork", &spork, true, true, false},
        {"pegasus", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"pegasus", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pegasusd, or the -server option to pegasus-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> pegasus-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6111/\n";
}
